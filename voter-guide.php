...
function register_my_custom_menu_page() {
    ...
    $iconURL= DAB_PATH_URL .'assets/img/dashicon.png';
...
function dab_init(){
    ...
    require_once(DAB_PATH.'inc/templates/single-questionnaire.php');
}
...
function load_admin_styles() {
    ...
    wp_enqueue_script( 'validate_jsdab', DAB_PATH_URL . 'assets/js/jquery.validate.js');
    wp_enqueue_script( 'custom_jsdab', DAB_PATH_URL . 'assets/js/custom.js', false, '1.0.0' );
}
...
function dab_custom_post_type_template($single_template) {
    ...
    if ($post->post_type == 'voter-guide' ) {
        $single_template = DAB_PATH.'inc/templates/single-questionnaire.php';
    }
