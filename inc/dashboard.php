...
?>
    <div style="padding-left: 0px; padding-right:20px; padding-top:0px;" class="dab_dashboard">
        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                <tr valign="top">
                    ...
                    <td><input type="password" name="new_option_name" value="<?php echo esc_attr( get_option('new_option_name') ); ?>" /> <p>Get your API Key at the <a href="https://console.developers.google.com/apis/credentials" target="_blank">Google APIs</a></p></td>
                ...
                <tr valign="top">
                    ...
                    <td colspan="2">
                        <table>
                            <tbody><tr> <th>Search: </th> <td><input type="text" name="tmp1" value="[voter_guide_search_form]" style="border:none; background:transparent; box-shadow:none; width: 300px;"></td> </tr>
                            <tr> <th> User Form: </th> <td><input type="text" name="tmp1" value="[voter_guide_form]" style="border:none; background:transparent; box-shadow:none; width: 300px;"></td> </tr>
                            </tbody></table>
                    </td>
                </tr>
        ...
        <div class="clear"></div></div> <?php echo $selected = get_option('thankyou_dab_option');